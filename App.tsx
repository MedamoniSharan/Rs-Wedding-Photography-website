...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    const structuredData = {
      ...
      url: 'https://rangasuryaphotography.comphotography.com',
      logo: 'https://rangasuryaphotography.comphotography.com/white_logo_design12.png',
      image: 'https://rangasuryaphotography.comphotography.com/IMG_3061.JPG',
